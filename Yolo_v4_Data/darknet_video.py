...
def cvDrawBoxes(detections, img):
    ...
    for detection in detections:
        ...
        xcenter1=int((xmin+xmax)//2)
        ycenter1=int((ymin+ymax)//2)
        pt1 = (xmin, ymin)
        pt2 = (xmax, ymax)
        cv2.rectangle(img, pt1, pt2, (0, 255, 0), 1)
        cv2.circle(img,(xcenter1,ycenter1),5,(255,255,255))
        cv2.putText(img,
                    detection[0].decode() +
...
def YOLO():
    ...
    weightPath = "./backup/yolov4-custom_last.weights"
   ...
   # ADDR = (SERVER, PORT)
    ...
    print("Starting the YOLO loop and Socket Connection with Raspberry Pi4")
